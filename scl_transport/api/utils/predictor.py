...
class Predictor(object):
    ...
    def client(self):
        if not self._client:
            self._client = zeep.Client('http://ws13.smsbus.cl/wspatentedos/services/PredictorParaderoServicioWS?wsdl')
        return self._client
    ...
    def _request_data(self, stop_code, route_id=''):
        ...
        return service.predictorParaderoServicio(
            paradero=stop_code,
            servicio='',
